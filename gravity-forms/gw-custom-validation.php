<?php
/**
 * Gravity Wizards // Gravity Forms // Custom Validation
 *
 * This snippet is an example of how to add custom validation to a Gravity Forms field that is activated by adding
