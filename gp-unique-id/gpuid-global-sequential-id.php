 ...
 *
 * Sets a globally sequential unique ID across all forms on the website. 
 ...
 *
 * Plugin Name:  GP Unique ID — Share a global sequential unique ID across all forms
 * Plugin URI:   https://gravitywiz.com/documentation/gravity-forms-unique-id/
 * Description:  Sets a globally sequential unique ID across all forms on the website. 
 * Author:       Gravity Wiz
 * Version:      0.1
