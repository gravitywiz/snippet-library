 ...
 *
 * Retroactively populate unique IDs into Unique ID fields. Useful when you want to regenerate the unique IDs within the form entries.
 * Usage:
 ...
 *
 * Plugin Name: GP Unique ID  - Retroactively Populate Unique IDs
 * Plugin URI: https://gravitywiz.com/documentation/gp-unique-id/
 * Description: Retroactively populate unique IDs into Unique ID fields.
 * Author: Gravity Wiz
 * Version: 0.1
