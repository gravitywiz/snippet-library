 ...
 * Description:  Capture a payment made via PayFast before generating the Unique ID.
 * Author:       Gravity Wiz
 * Version:      0.1
...
add_action( 'gform_payfast_payment_complete', function ( $pf_data ) {
	$entry = GFAPI::get_entry( $pf_data['m_payment_id'] );
